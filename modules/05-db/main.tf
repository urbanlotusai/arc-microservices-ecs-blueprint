...
# Module: 05-db
# =============================================================================
# Provisions the Aurora cluster used as the microservices platform's
# persistent data store.
# State file: modules/05-db/terraform.tfstate
# Depends on: 02-network (vpc_id, private subnets), 01-kms (encryption key)
# =============================================================================
